...
this.reportViewer1.RefreshReport();
        ...
        private void btncadastro_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    if (!objDados.IsClosed) { objDados.Close(); }
                    srtSql = "Insert into Produtos (Codigo,Nomee,Descrição,Valor,Fornecedor)values('" + txtcodigoi.Text + "','" +txtnomei.Text + "','" +txtdesci.Text + "','" +txtvalori.Text + "','" +txtforncedori.Text + "')";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    txtforncedor2.Text = objDados["Fornecedor"].ToString();
