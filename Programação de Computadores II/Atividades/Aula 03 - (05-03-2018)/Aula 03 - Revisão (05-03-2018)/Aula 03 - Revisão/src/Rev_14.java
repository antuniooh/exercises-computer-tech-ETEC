...
public class Rev_14 extends JFrame{
	...
	public Rev_14(){
		...
		rotulo1.setBounds(40,20,70,20);//x,y, largura,altura
		...
		tela.add(tam1);tela.add(tam2);tela.add(tam3);tela.add(tam4);
		tela.add(lista);
		setSize(500,300);
